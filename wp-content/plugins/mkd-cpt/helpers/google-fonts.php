<?php
if ( ! function_exists( 'newshub_mikado_init_google_fonts_array' ) ) {
    function newshub_mikado_init_google_fonts_array() {
    ...
    add_action('after_setup_theme', 'newshub_mikado_init_google_fonts_array');
}