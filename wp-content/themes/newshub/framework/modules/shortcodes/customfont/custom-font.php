<?php
namespace NewsHub\Modules\CustomFont;
...
class CustomFont implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
				'name' => esc_html__('Mikado Custom Font', 'newshub'),
				'base' => $this->getBase(),
				...
				'params' => array(
					array(
						"type" => "dropdown",
						'heading' => esc_html__('Custom Font Tag','newshub'),
					...
					array(
						"type" => "textfield",
						'heading' => esc_html__('Font family','newshub'),
					...
					array(
						...
						"value" => newshub_mikado_get_font_style_array(),
                        'save_always'	=> true
					),
					array(
						"type" => "dropdown",
						...
						"value" => newshub_mikado_get_font_weight_array(),
						"save_always" => true
					),
					array(
						"type" => "textfield",
					...
					array(
						...
						"value" => newshub_mikado_get_text_transform_array(),
                        'save_always'	=> true
					),
					array(
						"type" => "dropdown",
						'heading' => esc_html__('Text decoration','newshub'),
						"param_name" => "text_decoration",
						"value" => array(
							esc_html__("None", "newshub") => "",
							esc_html__("Underline", "newshub") => "underline",
							esc_html__("Overline", "newshub") => "overline",
							esc_html__("Line Through", "newshub") => "line-through"
						)
					),
					array(
						"type" => "colorpicker",
					...
					array(
						"type" => "dropdown",
						'heading' => esc_html__('Text Align','newshub'),
						...
						"value" => array(
							...
							esc_html__("Justify", "newshub") => "justify"
						)
					),
					array(
						"type" => "textarea",
	...
	public function render($atts, $content = null) {
		...
		$html = newshub_mikado_get_shortcode_module_template_part('templates/custom-font-template', 'customfont', '', $params);
