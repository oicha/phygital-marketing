<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="mkd-post-item-inner">
        ...
        <div class="mkd-post-title">
            <<?php echo esc_attr($title_tag); ?> class="mkd-link-text">
            <span><?php the_title(); ?></span>
        </<?php echo esc_attr($title_tag); ?>>
    </div>

    <a itemprop="url" class="mkd-post-link" href="<?php echo esc_url(get_post_meta(get_the_ID(), "mkd_post_link_link_meta", true)); ?>" title="<?php the_title_attribute(); ?>"></a>
