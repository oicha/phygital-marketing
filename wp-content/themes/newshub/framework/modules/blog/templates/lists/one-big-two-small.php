<div <?php echo newshub_mikado_class_attribute($blog_classes) ?>>
    ...
    <?php
    if (newshub_mikado_options()->getOptionValue('blog_list_one_big_two_small_section_title') === 'yes') {
    ...
    if ($blog_query->have_posts()) : while ($blog_query->have_posts()) : $blog_query->the_post();
        ...
        if ($i % 3 === 0) {
            ...
            if ($i % 3 === 1) {
                echo '</div></div></div>';
                echo '<div class="mkd-bnl-holder mkd-pl-six-holder mkd-post-columns-1">';
                echo '<div class="mkd-bnl-outer">';
                echo '<div class="mkd-bnl-inner">';
            }

            newshub_mikado_get_layout_post_format_html($blog_type, "second", "post-template-six");
