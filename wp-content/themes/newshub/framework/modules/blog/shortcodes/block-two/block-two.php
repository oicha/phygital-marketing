<?php
namespace NewsHub\Modules\Blog\Shortcodes\BlockTwo;
...
class BlockTwo extends ListShortcode
{
    ...
    public function __construct() {
        ...
        $this->shortcode_title = esc_html__('Mikado Block 2','newshub');
    ...
    public function render($atts, $content = null) {
        ...
        $args = array(
            ...
            'custom_thumb_image_height' => '95',
            'custom_thumb_image_width' => '95',
        ...
        if ($atts['query_result']->have_posts()):
            ...
            while ($atts['query_result']->have_posts()) : $atts['query_result']->the_post();
                ...
                if ($loop_counter == 1) {
                    $html .= '<div class="mkd-post-block-part mkd-post-block-featured mkd-pb-two-featured">';
                    //Get HTML from template
                    $html .= newshub_mikado_get_list_shortcode_module_template_part('post-template-one', 'templates', '', $params_featured_filtered);
                    $html .= '</div>';
                    $html .= '<div class="mkd-post-block-part mkd-post-block-non-featured mkd-pb-two-non-featured">';
                } else {
                    //Get HTML from template
