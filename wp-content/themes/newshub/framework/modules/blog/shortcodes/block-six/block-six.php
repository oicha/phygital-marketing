<?php
namespace NewsHub\Modules\Blog\Shortcodes\BlockSix;
...
class BlockSix extends ListShortcode
{
    ...
    public function __construct() {
        ...
        $this->shortcode_title = esc_html__('Mikado Block 6','newshub');
    ...
    public function render($atts, $content = null) {
        ...
        if ($atts['query_result']->have_posts()):
            ...
            while ($atts['query_result']->have_posts()) : $atts['query_result']->the_post();
                ...
                if ($loop_counter == 1) {
                    $html .= '<div class="mkd-post-block-part mkd-post-block-featured mkd-pb-six-featured">';
                    //Get HTML from template
                    $html .= newshub_mikado_get_list_shortcode_module_template_part('post-template-one', 'templates', '', $params_featured_filtered);
                    $html .= '</div>';
                    $html .= '<div class="mkd-post-block-part mkd-post-block-non-featured mkd-pb-six-non-featured">';
                } else {
                    //Get HTML from template
