<?php
namespace NewsHub\Modules\Blog\Shortcodes\PostLayoutFive;
...
class PostLayoutFive extends ListShortcode
{
    ...
    public function __construct() {
        ...
        $this->shortcode_title = esc_html__('Mikado Post Layout 5','newshub');
    ...
    public function render($atts, $content = null) {
        ...
        if ($atts['query_result']->have_posts()):
            while ($atts['query_result']->have_posts()) : $atts['query_result']->the_post();
                ...
                $html .= newshub_mikado_get_list_shortcode_module_template_part('post-template-five', 'templates', '', $params);
