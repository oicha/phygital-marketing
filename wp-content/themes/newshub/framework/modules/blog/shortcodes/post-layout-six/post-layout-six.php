<?php
namespace NewsHub\Modules\Blog\Shortcodes\PostLayoutSix;
...
class PostLayoutSix extends ListShortcode
{
    ...
    public function __construct() {
        ...
        $this->shortcode_title = esc_html__('Mikado Post Layout 6','newshub');
    ...
    public function render($atts, $content = null) {
        ...
        if ($atts['query_result']->have_posts()):
            while ($atts['query_result']->have_posts()) : $atts['query_result']->the_post();
                ...
                $html .= newshub_mikado_get_list_shortcode_module_template_part('post-template-six', 'templates', '', $params);
