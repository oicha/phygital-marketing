 ...
 * Class PostLayoutTwo
 */
class NewsHubMikadoPostLayoutTwo extends NewsHubMikadoWidget
{
    /**
    ...
    public function __construct() {
        parent::__construct(
            ...
            esc_html__('Mikado Post Layout Two Widget', 'newshub') // Name
        );
    ...
    public function widget($args, $instance) {
        ...
        echo '<div class="widget mkd-plw-two ' . $mkd_skin . '">';
        ...
        echo '</div>'; //close div.mkd-plw-two
    }
}