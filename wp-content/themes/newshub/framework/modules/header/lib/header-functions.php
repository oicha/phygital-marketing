<?php
use NewsHub\Modules\Header\Lib;

if(!function_exists('newshub_mikado_set_header_object')) {
    function newshub_mikado_set_header_object() {
    ...
    add_action('wp', 'newshub_mikado_set_header_object', 1);
}