...
class HeaderType3 extends HeaderType {
    ...
    public function __construct() {
        ...
        if(!is_admin()) {
            $logoAreaHeight       = newshub_mikado_filter_px(newshub_mikado_options()->getOptionValue('logo_area_height_header_type3'));
            $this->logoAreaHeight = $logoAreaHeight !== '' ? (int)newshub_mikado_filter_px($logoAreaHeight) : 185;

            $menuAreaHeight       = newshub_mikado_filter_px(newshub_mikado_options()->getOptionValue('menu_area_height_header_type3'));
            $this->menuAreaHeight = $menuAreaHeight !== '' ? (int)$menuAreaHeight : 45;
    ...
    public function loadTemplate($parameters = array()) {
        ...
        $parameters['logo_area_in_grid'] = newshub_mikado_options()->getOptionValue('logo_area_in_grid_header_type3') == 'yes' ? true : false;
        $parameters['menu_area_in_grid'] = newshub_mikado_options()->getOptionValue('menu_area_in_grid_header_type3') == 'yes' ? true : false;

        $parameters = apply_filters('newshub_mikado_header_type3_parameters', $parameters);
