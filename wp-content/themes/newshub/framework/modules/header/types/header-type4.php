...
/**
 * Class that represents Header Type 4 layout and option
 *
 * Class HeaderType4
 */
class HeaderType4 extends HeaderType {
    ...
    public function __construct() {
        ...
        if(!is_admin()) {
            $logoAreaHeight       = newshub_mikado_filter_px(newshub_mikado_options()->getOptionValue('logo_area_height_header_type4'));
            $this->logoAreaHeight = $logoAreaHeight !== '' ? (int)newshub_mikado_filter_px($logoAreaHeight) : (int)162;

            $menuAreaHeight       = newshub_mikado_filter_px(newshub_mikado_options()->getOptionValue('menu_area_height_header_type4'));
    ...
    public function calculateHeightOfTransparency() {
        ...
        if($headerTransparent) {
            $transparencyHeight = $this->logoAreaHeight + $this->menuAreaHeight + newshub_mikado_get_top_bar_height();
        }
    ...
    public function loadTemplate($parameters = array()) {
        ...
        $parameters['logo_area_in_grid'] = newshub_mikado_options()->getOptionValue('logo_area_in_grid_header_type4') == 'yes' ? true : false;
        $parameters['menu_area_in_grid'] = newshub_mikado_options()->getOptionValue('menu_area_in_grid_header_type4') == 'yes' ? true : false;

        $parameters = apply_filters('newshub_mikado_header_type4_parameters', $parameters);
