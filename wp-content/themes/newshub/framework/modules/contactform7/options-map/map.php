...
if ( ! function_exists('newshub_mikado_contact_form_7_options_map') ) {

	function newshub_mikado_contact_form_7_options_map() {

		newshub_mikado_add_admin_page(array(
			'slug'	=> '_contact_form7_page',
			'title'	=> esc_html__('Contact Form 7','newshub'),
			'icon'	=> 'fa fa-envelope-o'
		));

		$panel_contact_form_style_1 = newshub_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_1',
			'title'	=> esc_html__('Custom Style 1','newshub')
		));

		//Text Typography

		$typography_text_group = newshub_mikado_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography','newshub'),
			'description'	=> esc_html__('Setup typography for form elements text','newshub'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_text_row1 = newshub_mikado_add_admin_row(array(
		...
		newshub_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Text Color','newshub'),
		));
		...
		$typography_text_row2 = newshub_mikado_add_admin_row(array(
		...
		$typography_text_row3 = newshub_mikado_add_admin_row(array(
		...
		$typography_label_group = newshub_mikado_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography','newshub'),
			'description'	=> esc_html__('Setup typography for form elements label','newshub'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_label_row1 = newshub_mikado_add_admin_row(array(
		...
		$typography_label_row2 = newshub_mikado_add_admin_row(array(
		...
		$background_border_group = newshub_mikado_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border','newshub'),
			'description'	=> esc_html__('Setup form elements background and border style','newshub'),
			'parent'		=> $panel_contact_form_style_1
		));

		$background_border_row1 = newshub_mikado_add_admin_row(array(
		...
		newshub_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Transparency','newshub'),
		));
		...
		newshub_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Color','newshub')
		));
		...
		newshub_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Transparency','newshub')
		));

		$background_border_row2 = newshub_mikado_add_admin_row(array(
		...
		newshub_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Transparency','newshub'),
		));
		...
		newshub_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Color','newshub')
		));
		...
		newshub_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Transparency','newshub')
		));

		$background_border_row3 = newshub_mikado_add_admin_row(array(
		...
		newshub_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Width','newshub'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		newshub_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Radius','newshub'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$padding_group = newshub_mikado_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding','newshub'),
			'description'	=> esc_html__('Setup form elements padding','newshub'),
			'parent'		=> $panel_contact_form_style_1
		));

		$padding_row = newshub_mikado_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		newshub_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Top','newshub'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		newshub_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Right','newshub'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		newshub_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Bottom','newshub'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		newshub_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Left','newshub'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$margin_group = newshub_mikado_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin','newshub'),
			'description'	=> esc_html__('Setup form elements margin','newshub'),
			'parent'		=> $panel_contact_form_style_1
		));

		$margin_row = newshub_mikado_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		newshub_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Textarea Height','newshub'),
			'description'	=> esc_html__('Enter height for textarea form element','newshub'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$button_typography_group = newshub_mikado_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography','newshub'),
			'description'	=> esc_html__('Setup button text typography','newshub'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_typography_row1 = newshub_mikado_add_admin_row(array(
		...
		$button_typography_row2 = newshub_mikado_add_admin_row(array(
		...
		$button_background_border_group = newshub_mikado_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border','newshub'),
			'description'	=> esc_html__('Setup button background and border style','newshub'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_background_border_row1 = newshub_mikado_add_admin_row(array(
		...
		newshub_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Color','newshub')
		));
		...
		newshub_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Transparency','newshub')
		));

		$button_background_border_row2 = newshub_mikado_add_admin_row(array(
		...
		newshub_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Color','newshub')
		));
		...
		newshub_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Transparency','newshub')
		));

		$button_background_border_row3 = newshub_mikado_add_admin_row(array(
		...
		newshub_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Height','newshub'),
			'description'	=> esc_html__('Insert form button height','newshub'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		newshub_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Left/Right Padding','newshub'),
			'description'	=> esc_html__('Enter value for button left and right padding','newshub'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$panel_contact_form_style_2 = newshub_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2','newshub')
		));
	...
	add_action( 'newshub_mikado_options_map', 'newshub_mikado_contact_form_7_options_map', 15);
}