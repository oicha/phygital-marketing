...
if(!function_exists('newshub_mikado_get_wpml_pages_for_current_page')) {
	/**
	 ...
	 * @version 0.1
	 */
	function newshub_mikado_get_wpml_pages_for_current_page() {
		$wpml_pages_for_current_page = array();

		if(newshub_mikado_is_wpml_installed()) {
...
if(!function_exists('newshub_mikado_disable_wpml_css')) {
    function newshub_mikado_disable_wpml_css() {
	    define('ICL_DONT_LOAD_LANGUAGE_SELECTOR_CSS', true);
    }

	add_action('after_setup_theme', 'newshub_mikado_disable_wpml_css');
}