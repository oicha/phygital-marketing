...
class MikadoSkin extends NewsHubMikadoSkinAbstract {
    /**
     * Skin constructor. Hooks to newshub_mikado_admin_scripts_init and newshub_mikado_enqueue_admin_styles
     */
    public function __construct() {
        $this->skinName = 'mikado';

        //hook to
        add_action('newshub_mikado_admin_scripts_init', array($this, 'registerStyles'));
        add_action('newshub_mikado_admin_scripts_init', array($this, 'registerScripts'));

        add_action('newshub_mikado_enqueue_admin_styles', array($this, 'enqueueStyles'));
        add_action('newshub_mikado_enqueue_admin_scripts', array($this, 'enqueueScripts'));

        add_action('newshub_mikado_enqueue_meta_box_styles', array($this, 'enqueueStyles'));
        add_action('newshub_mikado_enqueue_meta_box_scripts', array($this, 'enqueueScripts'));
    ...
    public function registerScripts() {
        ...
        foreach ($this->scripts as $scriptHandle => $scriptPath) {
            newshub_mikado_register_skin_script($scriptHandle, $scriptPath);
        }
    }
    ...
    public function registerStyles() {
        ...
        foreach ($this->styles as $styleHandle => $stylePath) {
            newshub_mikado_register_skin_style($styleHandle, $stylePath);
        }
	...
	public function setIcons() {
        ...
        $icons_array = apply_filters('newshub_mikado_set_skin_icons', $icons_array, $this->getSkinURI() . '/');
	...
	public function setMenuItemPosition() {
        ...
        $positions_array = apply_filters('newshub_mikado_set_skin_menu_positions', $positions_array);
    ...
    public function renderOptions() {
        ...
        $tab    		= newshub_mikado_get_admin_tab();
        $active_page 	= $newshub_Framework->mkdOptions->getAdminPageFromSlug($tab);
     ...
     *
*@param NewsHubMikadoAdminPage $page current page to load
...
*@param NewsHubMikadoAdminPage $page current page to load
    ...
    public function renderImport() { ?>
        <div class="mkd-options-page mkd-page">
            <?php $this->getHeader(newshub_mikado_get_theme_info_item('Name'), newshub_mikado_get_theme_info_item('Version'), false); ?>
            <div class="mkd-page-content-wrapper">
                <div class="mkd-page-content">
                    <div class="mkd-page-navigation mkd-tabs-wrapper vertical left clearfix">
