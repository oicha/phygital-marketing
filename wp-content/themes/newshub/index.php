<?php
$newshub_blog_archive_pages_classes = newshub_mikado_blog_archive_pages_classes(newshub_mikado_get_default_blog_list());
?>
<?php get_header(); ?>
...
<div class="<?php echo esc_attr($newshub_blog_archive_pages_classes['holder']); ?>">
	...
	<div class="<?php echo esc_attr($newshub_blog_archive_pages_classes['inner']); ?>">
		<?php newshub_mikado_get_blog(newshub_mikado_get_default_blog_list()); ?>
	</div>
