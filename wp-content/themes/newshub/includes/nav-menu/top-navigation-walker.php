 ...
 */
if (!class_exists('NewsHubMikadoTopNavigationWalker')) {
	class NewsHubMikadoTopNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				$angle_icon   = '';
				if($depth !== 0) {
					$angle_icon = '<i class="mkd-menu-arrow arrow_carrot-right"></i>';
				}
