...
if (!class_exists('NewsHubMikadoMobileNavigationWalker')) {
	class NewsHubMikadoMobileNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				if($args->has_children) {
					$item_output .= '<span class="mobile_arrow"><i class="mkd-sub-arrow arrow_carrot-right"></i></span>';
				}
			}
