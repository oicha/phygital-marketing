 ...
 */
if (!class_exists('NewsHubMikadoStickyNavigationWalker')) {
	class NewsHubMikadoStickyNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				$angle_icon   = '';
				if($depth !== 0) {
					$angle_icon = '<i class="mkd-menu-arrow ion-ios-arrow-right"></i>';
				}
				...
				if($args->has_children && $depth == 0) {
					$item_output .= '<span class="mkd-menu-arrow ion-ios-arrow-down"></span>';
				}
